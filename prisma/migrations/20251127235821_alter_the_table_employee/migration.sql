/*
  ...
  - You are about to drop the column `user` on the `employees` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "employees_user_key";

-- AlterTable
ALTER TABLE "employees" DROP COLUMN "user",
