"""
Django settings for ProjectDomSS project.
...
SECRET_KEY = '4oi%^c#g6r$e0@xhdxxt^^q7&l5xa@g+$y73t*e4!@%v1m491g'
...
ROOT_URLCONF = 'ProjectDomSS.urls'
...
WSGI_APPLICATION = 'ProjectDomSS.wsgi.application'
